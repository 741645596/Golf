    ...
    public class ValueMember
    {
        ...
        private static object ParseDefaultValue(Type type, object value)
        {
            ...
            if (value is string s) {
                if (Helpers.IsEnum(type)) {
                    return Helpers.ParseEnum(type, s);
                }
        ...
        internal bool ResolveMapTypes(out Type dictionaryType, out Type keyType, out Type valueType)
        {
            ...
            try {
                ...
                var info = memberType;
#endif
                if (ImmutableCollectionDecorator.IdentifyImmutable(model, MemberType, out var _1, out var _2, out var _3, out var _4, out var _5, out var _6)) {
                    return false;
                }
